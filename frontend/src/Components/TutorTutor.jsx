...
import tutortutor from "./tutortutor.png";
      ...
      <div className="tutor-tutor">
        <div className="tutor-h">
          ...
          <p>
            ...
            <span>
              <a href="http://localhost:3000/tutors">Sign up</a>
            </span>{" "}
            to start tutoring online with SALAHAKAAR.
          </p>
        </div>
      </div>
      <TutorBenefits />
      <div className="why-tutors">
        <div className="trfvbhyy">
          <p>
        ...
        <img src={tutortutor} alt="Tutor Tutor a4567890" />
      </div>
    </>
  );
};
